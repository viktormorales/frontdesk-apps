...
function ResponsiveDrawer(props) {
	...
	const menuItems = [
		{ "icon": <DashboardIcon />, "text": "Escritorio", "link": "/admin" },
	...
	return (
		<div id="adminArea" className={classes.root}>
			<CssBaseline />
			<AppBar position="fixed" className={classes.appBar}>
				<Toolbar>
					...
					<Typography variant="h6" noWrap>
						Hotel Cilene del Faro
					</Typography>
				</Toolbar>
			</AppBar>
			<nav id="adminSidebar" className={classes.drawer} aria-label="mailbox folders">
